...
function GUICreate()
	...
	Skin2 = { tex1="misc_button_d.bmp", tex2="0", tex3="0", tex4="0", tex1a="0", tex2a="0", tex3a="0", tex4a="0", bkR=255,
	 bkG=255, bkB=255, borderR=255, borderG=255, borderB=255, bd_size=0, tile=0, trans=0 }
	Skin3 = { tex1="final/big_corner.bmp", tex2="0", tex3="0", tex4="0", tex1a="final/big_corner_a.bmp", tex2a="0",
	...
	Skin6 = { tex1="misc_button_u.bmp", tex2="0", tex3="0", tex4="0", tex1a="0", tex2a="0", tex3a="0", tex4a="0", bkR=192,
	...
	ChangeSkin("MLStartWnd","Skin4","Window")

	CreateWnd(1,"QuitBn","MLStartWnd","Quit",352,426,96,40,0,4,0)
	ChangeSkin("QuitBn","Skin5","Button up")
	...
	ChangeSkin("StarNewGameBn","Skin6","Button up")
	ChangeSkin("StarNewGameBn","Skin2","Button down")
	ChangeSkin("StarNewGameBn","Skin1","Button focus")

	CreateWnd(1,"ContinueGameBn","MLStartWnd","Continue",697,551,96,40,0,3,0)
	...
	CreateWnd(4,"Label41","MLStartWnd","",314,187,151,150,0,4,0)
	ChangeSkin("Label41","Skin3","Label")
