...
Skin1 = { tex1="map_icons/policestation.bmp", tex2="0", tex3="0", tex4="0", 
...
function OnMissionStart()
	...
	AddItem(hq, "data/script/objects/t_bomb.lua", 0)
	...
	local police1 = RunScript("data/script/objects/t_police.lua", -1, pos1)
	...
	local police2 = RunScript("data/script/objects/t_police.lua", -1, pos2)
	...
	local police3 = RunScript("data/script/objects/t_police.lua", -1, pos3)
...
function BlowupPoliceStation()
	...
	RunScript("data/script/objects/t_bigexposion.lua",BombEntID);
