...
function GUICreate()
	...
	CreateWnd(1,"PauseBn","GamePlayScreen","",8,461,32,28,0)
	...
	CreateWnd(1,"HQBn","GamePlayPanelWnd","",25,10,32,32,0)
	ChangeSkin("HQBn","Skin22","Button up")
	ChangeSkin("HQBn","Skin23","Button down")
	ChangeSkin("HQBn","Skin24","Button focus")

	CreateWnd(4,"TimeLeftLabel","GamePlayScreen","12:24",50,465,50,20,0)
