...
--	 borderR=255, borderG=255, borderB=255, bd_size=0, tile=1, trans=0 }
	...
	CreateWnd(0,"action_bar","GamePlayScreen","",42,512,256,64,0,2,0)
	ChangeSkin("action_bar","Skin5","Window")

	CreateWnd(1,"action_button","action_bar","",238,-5,32,64,0,0,0)
	...
	CreateWnd(0,"item_bar","GamePlayScreen","",298,499,512,128,0,3,0)
	ChangeSkin("item_bar","Skin9","Window")

	CreateWnd(1,"item_button","item_bar","",85,-25,64,128,0,0,0)
	...
	CreateWnd(1,"GamePlayDlgQuickItem1","item_bar","",145,30,32,32,0,0,0)
	...
	CreateWnd(1,"GamePlayDlgQuickItem2","item_bar","",181,30,32,32,0,0,0)
	...
	CreateWnd(1,"GamePlayDlgQuickItem3","item_bar","",145,66,32,32,0,0,0)
	...
	CreateWnd(1,"GamePlayDlgQuickItem4","item_bar","",181,66,32,32,0,0,0)
	...
	CreateWnd(1,"GamePlayDlgWeaponBn","item_bar","",248,32,96,64,0,0,0)
	...
	CreateWnd(0,"skill_bar","GamePlayScreen","",-51,552,512,64,0,2,0)
	ChangeSkin("skill_bar","Skin12","Window")

	CreateWnd(1,"skill_button","skill_bar","",400,-14,64,64,0,0,0)
	...
	CreateWnd(0,"wind_char","GamePlayScreen","",-1,346,256,256,0,2,0)
	ChangeSkin("wind_char","Skin14","Window")

	CreateWnd(0,"wind_map","GamePlayScreen","",546,346,256,256,0,3,0)
	ChangeSkin("wind_map","Skin15","Window")

	CreateWnd(1,"char_panel_button","panel_char","",0,11,128,64,0,0,0)
	...
	CreateWnd(1,"item_button_ext","wind_map","",77,127,64,128,0,0,0)
	...
	CreateWnd(1,"char_panel_button_ext","wind_char","",0,99,128,64,0,0,0)
	...
	CreateWnd(1,"action_button_ext","wind_char","",135,160,32,64,0,0,0)
	...
	CreateWnd(1,"skill_button_ext","wind_char","",105,192,64,64,0,0,0)
	...
	CreateWnd(1,"GamPlayMenuBn","wind_map","",133,183,24,24,0,0,0)
...
--	ChangeSkin("GamPlayMenuBn","Skin1","Button focus")
	...
	CreateWnd(1,"ActiveCharacterPortraitBn","wind_char","",-4+8+4,128+24,96,96,0,0,0)
	...
	CreateWnd(4,"ActiveCharacterPortraitLabel","wind_char","",-4+8+4,128+24,96,96,0,0,0)
	ChangeSkin("ActiveCharacterPortraitLabel","Skin28","Label")




	CreateWnd(0,"MissionInfoWnd","GamePlayScreen","",800/2-256/2,600/2-256/2,256,256,0,0,0)
	ChangeSkin("MissionInfoWnd","Skin26","Window")

	CreateWnd(10,"MissionInfoLabel","MissionInfoWnd","",10,10,235,190,0,0,0)
	ChangeSkin("MissionInfoLabel","Skin27","Textbox")

	CreateWnd(1,"MissionInfoOK","MissionInfoWnd","OK",256/2-96/2,256-40,96,40,0,0,0)
	...
	CreateWnd(0,"MapWnd","GamePlayScreen","",200,0,600,448,0,1,0)
	ChangeSkin("MapWnd","Skin31","Window")

	
	CreateWnd(4,"AgentMapIcon1","MapWnd","",0,0,16,16,0,0,0)
	ChangeSkin("AgentMapIcon1","Skin32","Label")

	CreateWnd(4,"AgentMapIcon2","MapWnd","",0,0,16,16,0,0,0)
	ChangeSkin("AgentMapIcon2","Skin32","Label")

	CreateWnd(4,"AgentMapIcon3","MapWnd","",0,0,16,16,0,0,0)
	ChangeSkin("AgentMapIcon3","Skin32","Label")

	CreateWnd(4,"AgentMapIcon4","MapWnd","",0,0,16,16,0,0,0)
	ChangeSkin("AgentMapIcon4","Skin32","Label")

	CreateWnd(4,"AgentMapIcon5","MapWnd","",0,0,16,16,0,0,0)
	ChangeSkin("AgentMapIcon5","Skin32","Label")


	CreateWnd(0,"HelpWnd","GamePlayScreen","",150,32,512,380,0,6,0)
	ChangeSkin("HelpWnd","Skin26","Window")

	CreateWnd(10,"HelpWnd","GamePlayScreen","",150,32,512,380,0,0,0)
	ChangeSkin("HelpWnd","Skin26","Window")

	CreateWnd(10,"HelpTextEb","HelpWnd","",0,0,512-16,380-64,0,0,0)
	ChangeSkin("HelpTextEb","Skin33","Textbox")

	CreateWnd(1,"HelpTextOK","HelpWnd","OK",512/2-96/2,380-40,96,40,0,0,0)
