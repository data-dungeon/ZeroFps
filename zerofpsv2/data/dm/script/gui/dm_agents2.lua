...
function GUICreate()
	...
	-- Skins.
	-------------------------------------------------------------------------
	Skin1 = { tex1="label_bk.bmp", tex2="0", tex3="0", tex4="0", tex1a="0", tex2a="0", tex3a="0", tex4a="0", bkR=255,
	...
	Skin3 = { tex1="misc_button_d.bmp", tex2="0", tex3="0", tex4="0", tex1a="0", tex2a="0", tex3a="0", tex4a="0", bkR=255,
	 bkG=255, bkB=255, borderR=255, borderG=255, borderB=255, bd_size=0, tile=0, trans=0 }
	Skin4 = { tex1="misc_button_u.bmp", tex2="0", tex3="0", tex4="0", tex1a="0", tex2a="0", tex3a="0", tex4a="0", bkR=255,
	 bkG=255, bkB=255, borderR=255, borderG=255, borderB=255, bd_size=0, tile=0, trans=0 }
	Skin5 = { tex1="portraits/portrait5.bmp", tex2="0", tex3="0", tex4="0", tex1a="0", tex2a="0", tex3a="0", tex4a="0",
	 bkR=255, bkG=255, bkB=255, borderR=255, borderG=255, borderB=255, bd_size=0, tile=0, trans=0 }
	Skin6 = { tex1="portraits/portrait5b.bmp", tex2="0", tex3="0", tex4="0", tex1a="0", tex2a="0", tex3a="0", tex4a="0",
	 bkR=255, bkG=255, bkB=255, borderR=255, borderG=255, borderB=255, bd_size=0, tile=0, trans=0 }
	...
	Skin9 = { tex1="final/members/right_button.bmp", tex2="0", tex3="0", tex4="0", tex1a="0", tex2a="0", tex3a="0", tex4a="0", bkR=255,
	 bkG=255, bkB=255, borderR=255, borderG=255, borderB=255, bd_size=0, tile=0, trans=0 }
	Skin10 = { tex1="final/members/right_arrow_d.bmp", tex2="0", tex3="0", tex4="0", tex1a="0", tex2a="0", tex3a="0", tex4a="0", bkR=255,
	 bkG=255, bkB=255, borderR=255, borderG=255, borderB=255, bd_size=0, tile=0, trans=0 }
	Skin11 = { tex1="final/members/right_button.bmp", tex2="0", tex3="0", tex4="0", tex1a="0", tex2a="0", tex3a="0", tex4a="0", bkR=255,
	 bkG=255, bkB=255, borderR=255, borderG=255, borderB=255, bd_size=0, tile=0, trans=0 }
	Skin12 = { tex1="final/members/left_arrow.bmp", tex2="0", tex3="0", tex4="0", tex1a="0", tex2a="0", tex3a="0", tex4a="0", bkR=255,
	 bkG=255, bkB=255, borderR=255, borderG=255, borderB=255, bd_size=0, tile=0, trans=0 }
	Skin13 = { tex1="final/members/left_arrow_d.bmp", tex2="0", tex3="0", tex4="0", tex1a="0", tex2a="0", tex3a="0", tex4a="0", bkR=255,
	 bkG=255, bkB=255, borderR=255, borderG=255, borderB=255, bd_size=0, tile=0, trans=0 }
	Skin14 = { tex1="final/members/left_arrow.bmp", tex2="0", tex3="0", tex4="0", tex1a="0", tex2a="0", tex3a="0", tex4a="0", bkR=255,
	 bkG=255, bkB=255, borderR=255, borderG=255, borderB=255, bd_size=0, tile=0, trans=0 }
	...
	-------------------------------------------------------------------------
	CreateWnd(0,"AgentsWnd","","",800/2-512/2,600/2-530/2,512,530,0,6,0)
	ChangeSkin("AgentsWnd","Skin8","Window")

	CreateWnd(4,"CurrentAgentToHireLabel","AgentsWnd","Agent for hire 1/40 - Mr Smith",32,214,449,16,0,0,0)
	ChangeSkin("CurrentAgentToHireLabel","Skin1","Label")

	CreateWnd(1,"FireAgentBn","AgentsWnd","Fire",388,150,80,33,0,0,0)
...
--	ChangeSkin("GuiMainWnd","Skin7","Window")
	...
	CreateWnd(1,"HireAgentBn","AgentsWnd",HireBnText,512/2-120/2,315,120,33,0,0,0)
	ChangeSkin("HireAgentBn","Skin2","Button up")
	ChangeSkin("HireAgentBn","Skin3","Button down")
	ChangeSkin("HireAgentBn","Skin4","Button focus")

	CreateWnd(1,"NextAgentInHQ","AgentsWnd","",482,51,16,16,0,0,0)
	...
	CreateWnd(1,"NextAgentToHireBn","AgentsWnd","",482,214,16,16,0,0,0)
	...
	CreateWnd(1,"PrevAgentInHQBn","AgentsWnd","",15,51,16,16,0,0,0)
	...
	CreateWnd(1,"PrevAgentToHireBn","AgentsWnd","",15,214,16,16,0,0,0)
	...
	CreateWnd(1,"SendOutAgentBn","AgentsWnd","Send out",48,149,80,33,0,0,0)
	...
	CreateWnd(4,"AgentInFocusMemberAim","AgentsWnd","Aim:",15,424,481,20,0,0,0)
	ChangeSkin("AgentInFocusMemberAim","Skin1","Label")

	CreateWnd(4,"AgentInFocusMemberArmor","AgentsWnd","Armor:",15,464,481,20,0,0,0)
	ChangeSkin("AgentInFocusMemberArmor","Skin1","Label")

	CreateWnd(4,"AgentInFocusMemberHP","AgentsWnd","HP:",15,404,481,20,0,0,0)
	ChangeSkin("AgentInFocusMemberHP","Skin1","Label")

	CreateWnd(4,"AgentInFocusMemberInfoTxt","AgentsWnd","SELECTED AGENT",15,362,481,20,0,0,0)
	ChangeSkin("AgentInFocusMemberInfoTxt","Skin1","Label")

	CreateWnd(4,"AgentInFocusMemberLevel","AgentsWnd","Level:",15,504,481,20,0,0,0)
	ChangeSkin("AgentInFocusMemberLevel","Skin1","Label")

	CreateWnd(4,"AgentInFocusMemberName","AgentsWnd","Name:",15,384,481,20,0,0,0)
	ChangeSkin("AgentInFocusMemberName","Skin1","Label")

	CreateWnd(4,"AgentInFocusMemberSpeed","AgentsWnd","Speed:",15,444,481,20,0,0,0)
	ChangeSkin("AgentInFocusMemberSpeed","Skin1","Label")

	CreateWnd(4,"AgentInFocusMemberWage","AgentsWnd","Wage:",15,484,481,20,0,0,0)
	ChangeSkin("AgentInFocusMemberWage","Skin1","Label")

	CreateWnd(4,"AgentInHQLabel","AgentsWnd","Your agent 1/10 - Mr Smith",32,51,449,16,0,0,0)
	...
	CreateWnd(2,"AgentsInHQBn2","AgentsWnd","",85,73,64,64,0,0,0)
	...
	CreateWnd(2,"AgentsInHQBn3","AgentsWnd","",154,73,64,64,0,0,0)
	...
	CreateWnd(2,"AgentsInHQBn4","AgentsWnd","",223,73,64,64,0,0,0)
	...
	CreateWnd(2,"AgentsInHQBn5","AgentsWnd","",293,73,64,64,0,0,0)
	...
	CreateWnd(2,"AgentsInHQBn6","AgentsWnd","",363,73,64,64,0,0,0)
	...
	CreateWnd(2,"AgentsInHQBn7","AgentsWnd","",433,73,64,64,0,0,0)
	...
	CreateWnd(4,"AgentsMoneyLabel","AgentsWnd","Money:",14,15,274,20,0,0,0)
	ChangeSkin("AgentsMoneyLabel","Skin1","Label")

	CreateWnd(4,"AgentsReputaionLabel","AgentsWnd","Reputation: ",288,15,200,20,0,0,0)
	ChangeSkin("AgentsReputaionLabel","Skin1","Label")

	CreateWnd(1,"AgentsShop","AgentsWnd","Shop",161,150,80,33,0,0,0)
	ChangeSkin("AgentsShop","Skin2","Button up")
	ChangeSkin("AgentsShop","Skin3","Button down")
	ChangeSkin("AgentsShop","Skin4","Button focus")

	CreateWnd(2,"AgentsToHireBn1","AgentsWnd","",15,238,64,64,0,0,0)
	...
	CreateWnd(2,"AgentsToHireBn2","AgentsWnd","",84,238,64,64,0,0,0)
	...
	CreateWnd(2,"AgentsToHireBn3","AgentsWnd","",154,238,64,64,0,0,0)
	...
	CreateWnd(2,"AgentsToHireBn4","AgentsWnd","",224,238,64,64,0,0,0)
	...
	CreateWnd(2,"AgentsToHireBn5","AgentsWnd","",294,238,64,64,0,0,0)
	...
	CreateWnd(2,"AgentsToHireBn6","AgentsWnd","",363,238,64,64,0,0,0)
	...
	CreateWnd(2,"AgentsToHireBn7","AgentsWnd","",433,238,64,64,0,0,0)
