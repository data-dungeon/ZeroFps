...
--	 bkG=255, bkB=255, borderR=255, borderG=255, borderB=255, bd_size=0, tile=0, trans=0 }
	...
	-------------------------------------------------------------------------
	CreateWnd(0,"DMStartWnd","","",0,0,800,600,0,0,3)
...
--	ChangeSkin("GuiMainWnd","Skin6","Window")
	...
	CreateWnd(1,"StarNewGameBn","DMStartWnd","New",800/2-96/2,y+50*0,96,40,0,4,0)
	...
	CreateWnd(1,"LoadNewGameBn","DMStartWnd","Load",800/2-96/2,y+50*1,96,40,0,4,0)
	...
	CreateWnd(1,"SaveNewGameBn","DMStartWnd","Save",800/2-96/2,y+50*2,96,40,0,4,0)
