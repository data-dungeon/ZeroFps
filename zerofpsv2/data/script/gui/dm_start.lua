...
function GUICreate()
	...
	Skin5 = { tex1="dm/city1.bmp", tex2="wndborder_left.bmp", tex3="wndborder_top.bmp", tex4="wndborder_corner.bmp",
	...
	CreateWnd(1,"LoadNewGameBn","DMStartWnd","Load",365,148,70,20,0)
	...
	CreateWnd(1,"StarNewGameBn","DMStartWnd","Start",365,120,70,20,0)
