...
function GUICreate()
	...
	Skin5 = { tex1="wnd_bk.bmp", tex2="wndborder_left.bmp", tex3="wndborder_top.bmp", tex4="wndborder_corner.bmp",
	...
	ChangeSkin("BuyWnd","Skin5","Window")
	...
	CreateWnd(1,"BuyBn","BuyWnd","Buy",67,317,64,20,0)
