...
-- custom skins
NullSkin  = { trans=1 }
WorkButtonSkinUp     = { tex1= "workbutton_u.bmp" }
WorkButtonSkinDown   = { tex1= "workbutton_d.bmp" }
WorkButtonSkinFocus  = { tex1= "workbutton_f.bmp" }

ToogleLightButtonSkinUp     = { tex1= "togglelight_u.bmp" }
ToogleLightButtonSkinDown   = { tex1= "togglelight_d.bmp" }

RotateButtonSkinUp     = { tex1= "rot_u.bmp" }
RotateButtonSkinDown   = { tex1= "rot_d.bmp" }
RotateButtonSkinFocus  = { tex1= "rot_f.bmp" }

DeleteButtonSkinUp     = { tex1= "delete_u.bmp" }
