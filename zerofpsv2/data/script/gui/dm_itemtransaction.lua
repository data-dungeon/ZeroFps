...
function GUICreate()
	...
	CreateWnd(0,"ItemAddWnd","ItemTransactionWnd","",40,40,256,348,0)
	ChangeSkin("ItemAddWnd","Skin6","Window")

	CreateWnd(0,"ItemRemoveWnd","ItemTransactionWnd","",380,40,256,348,0)
	ChangeSkin("ItemRemoveWnd","Skin5","Window")

	CreateWnd(1,"RemoveItemBn","ItemRemoveWnd","Sell",93,318,70,20,0)
	...
	CreateWnd(1,"AddItemBn","ItemAddWnd","Buy",93,317,64,20,0)
	...
	CreateWnd(1,"ItemAddTransactionNextPageBn","ItemAddWnd","",230,318,20,20,0)
	...
	CreateWnd(1,"ItemAddTransactionPrevPageBn","ItemAddWnd","",4,318,20,20,0)
	...
	CreateWnd(1,"ItemRemoveTransactionNextPageBn","ItemRemoveWnd","",230,318,20,20,0)
	...
	CreateWnd(1,"ItemRemoveTransactionPrevPageBn","ItemRemoveWnd","",4,318,20,20,0)
