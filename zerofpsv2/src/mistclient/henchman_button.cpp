...
HenchmanButton::HenchmanButton(ZGuiApp* pkApp, int iIconID, int iPos)
{
	...
	pkApp->CreateWnd(Checkbox, szName, "MainWnd", "", /*pkApp->GetWidth()*/800-51, 4+iPos*56, 48, 48, 0);
	...
	pkApp->CreateWnd(Label, szName, "MainWnd", "", /*pkApp->GetWidth()*/800-51, 52+iPos*56, 48, 4, 0);
