...
EntityManager::~EntityManager() 
{
	...
	// Obs! H� skall resursen laddas ur, g� dock inte pga timeout expire.
...
Entity* EntityManager::CreateEntityByNetWorkID(int iNetID)
{
	...
	pkNew->SetInterpolateFactor(8.0);
...
{	
	...
	kZoneEntity->m_iCurrentZone = iId;						//hack f� att snabbt kunna se villken zon zonentityt tillh�
