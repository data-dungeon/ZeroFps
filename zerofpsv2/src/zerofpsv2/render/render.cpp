...
void ZSSRender::DumpGLState(char* szFileName)
{
	...
	GlDump_GetIntv(GL_MAX_VERTEX_ATTRIBS,					"GL_MAX_VERTEX_ATTRIBS", 1);			
	GlDump_GetIntv(GL_MAX_VERTEX_UNIFORM_COMPONENTS,	"GL_MAX_VERTEX_UNIFORM_COMPONENTS", 1);			
	GlDump_GetIntv(GL_MAX_VARYING_FLOATS,					"GL_MAX_VARYING_FLOATS", 1);			
	GlDump_GetIntv(GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS,	"GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS", 1);			
	GlDump_GetIntv(GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS,	"GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS", 1);			
	GlDump_GetIntv(GL_MAX_TEXTURE_IMAGE_UNITS,			"GL_MAX_TEXTURE_IMAGE_UNITS", 1);			
	GlDump_GetIntv(GL_MAX_FRAGMENT_UNIFORM_COMPONENTS,	"GL_MAX_FRAGMENT_UNIFORM_COMPONENTS", 1);			
