...
int DEBUG_PRINT = false;			// S�t till true f� att printa bitmap/tga/pcx/whatever loaded.
...
bool Image::load_pcx(FILE *fp, color_rgb* pal)
{
	...
	//delete [] data1;	// ** Fix_me ** [Vim], [L�ker som ett s�l :)]
	return true;
}
...
bool Image::load_bmp(FILE* pkFile)
{
	...
	// Testa f� om ulSizeImage � 0. Adobe Phoshop s�ter denna 
	// flagga till noll Windows Paint g� det inte.
