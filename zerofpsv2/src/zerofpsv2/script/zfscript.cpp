...
///////////////////////////////////////////////////////////////////////////////
// Name:		OpenLua
// Description:	Starta lua, �pna vissa hj�pfunktioner och skapa ett alla de
//				tag metoder som kr�s f� att kunna registrera globala variabler
//				till Lua.
//
...
string ZFScriptSystem::FormatMultiLineTextFromLua(string strLuaText)
{
	...
	// Ta f�st bort Lua's alla radtecken.
	...
	// L�g sedan till radtecken d� ett '\n' finns.
	for(int j=0; j<strLuaText.size(); j++)
	{
