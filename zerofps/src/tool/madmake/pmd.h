...
public:
	void Clear(void);
	void operator=(const Pmd_KeyFrame& kOther);
...
public:
	void Clear(void);
	void operator=(const Pmd_Animation& kOther);
...
public:
	...
	vector<Pmd_Animation>	kAnimation;
	Pmd_Animation*	GetAnimation(char* ucaName);
	void PrintAnimations(void);
